...
void outcome(string codeAdd, string codeMul)
{
	...
	cout << "RS" << endl;
	cout << "RS1 |" << setw(4) << RSAdd[0].operand << "|" << setw(4) << RSAdd[0].val1 << "|" << setw(4) << RSAdd[0].val2 << "|" << endl;
	cout << "RS2 |" << setw(4) << RSAdd[1].operand << "|" << setw(4) << RSAdd[1].val1 << "|" << setw(4) << RSAdd[1].val2 << "|" << endl;
	cout << "RS3 |" << setw(4) << RSAdd[2].operand << "|" << setw(4) << RSAdd[2].val1 << "|" << setw(4) << RSAdd[2].val2 << "|" << endl;
	cout << "BYFFER:" << codeAdd << endl;
	cout << endl;
